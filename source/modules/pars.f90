...
! nys=ny/nslab=256/6=24
  ...
  INTEGER, PARAMETER :: iti=0, itmax=5000000, imean=1, ihst=100000, itape=100000,        &
  itstr=1, it_his=100000, i_viz=5000000

  INTEGER, PARAMETER :: nscl = 7, nvar = (4+nscl) !number of scalars and vars
